![Wizkit](https://bitbucket.org/surgemcgee/wizkit/raw/default/docs/images/Wizkit_logo_2_240x317.png)

## A functional programming utility kit with a robust terminal logger.
...
var aaa
var logger = up.color(true).sp("STRING").sp(1).add
logger(null).sp(aaa).space("F"*2).log("Cool")

var log_callback = up.color(true).sp("A callback logger function which prints when ther callback is ran.").log
log_callback(1,2,3)
...
var test_callbacks = function() {
  ...
  cb_a = up.error_cb(cb_a, "Message for end user display") // Messages do no regard the debug state and are always availible
  cb_a("An internally generated error message")
...
```
![Wizkit!](https://bitbucket.org/surgemcgee/wizkit/raw/default/docs/images/Wizkit_animation.gif)

![Wizkit!](https://bitbucket.org/surgemcgee/wizkit/raw/default/docs/images/Wizkit_callback_output.jpg)
